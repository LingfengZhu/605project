...
* Reddit can monitor active communities and users.

* Reddit can relate comment-activity trend with big events such as game lunch and Black Friday together, then allocate sources more efficiently.

* Reddit can monitor the daily trend of a word appearance such as "witcher" to see what topics are popular.
